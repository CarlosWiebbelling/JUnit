...
/**
 * This class is the controller of the activity log screen:
 * <code>ActivityLog.fxml</code> for manager. Allows the manager to view records
 * of staffs and manager activities.
 *
 * @author Mingxuan Mei
 * @version 1.0
 * @since 2016-12-16
...
public class ActivityController implements Initializable {
     ...
     * <code>TableView activityTable</code>, populate the TableView with all
     * recorded activities in the database.
     *
     *
     * @author Mingxuan Mei
     * @version 1.0
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        try {
            ...
            lblStatus.setText("The log are being shown");
    ...
    /**
     * <code>back</code> Switch the screen back to <code>EditStaff.fxml</code>
     * for manager.
     *
