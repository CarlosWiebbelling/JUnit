...
/**
 * This class is the controller of the home screens after login screen:
 * <code>AdmiIn.fxml</code> and <code>StaffIn.fxml</code> for manager and staff
 * respectively, give access to all functions of the app.
 *
 * @author Mingxuan Mei
 * @version 1.0
 * @since 2016-12-16
...
public class MainController implements Initializable {
    ...
    /**
     * <code>initialize</code> Initialise the screens with 5 variables, one for
     * each table, to achieve the "click table once for new order, click again
     * for modify order" function.
     *
     *
     * @author Mingxuan Mei
     * @version 1.0
    ...
    /**
     * <code>logout</code> Log current user out and switch the screen to
     * Login.fxml. Record this activity into database.
     *
...
//        Previous form to start a new Scene
//        Parent root = FXMLLoader.load(getClass().getResource("/application/Login.fxml"));
//        Scene scene = new Scene(root);
//        scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
//        Main.thestage.setScene(scene);
        Parent window3 = (AnchorPane) FXMLLoader.load(getClass().getResource("/application/Login.fxml"));
        ...
        try {
            ...
            newOrderSpecialReq.setOnEditCommit(
                ...
                public void handle(CellEditEvent<Menu, String> t) {
                    ((Menu) t.getTableView().getItems().get(
                            t.getTablePosition().getRow())).setspecialReq(t.getNewValue());
                }
            }
            );
...
//            Main.thestage.setScene(scene3);
            //New Form
            Parent window3 = (AnchorPane) FXMLLoader.load(getClass().getResource("/application/Search.fxml"));
            Scene newScene = new Scene(window3);
...
//            Main.thestage.setScene(scene3);
        //New Form
            Parent window3 = (AnchorPane) FXMLLoader.load(getClass().getResource("/application/EditStaff.fxml"));
            Scene newScene = new Scene(window3);
            Stage mainWindow = (Stage) ((Node) e.getSource()).getScene().getWindow();
            mainWindow.setScene(newScene);
...
//            Main.thestage.setScene(scene3);
            //New Form
            Parent window3 = (AnchorPane) FXMLLoader.load(getClass().getResource("/application/StaffSearch.fxml"));
            Scene newScene = new Scene(window3);
            Stage mainWindow = (Stage) ((Node) e.getSource()).getScene().getWindow();
            mainWindow.setScene(newScene);
...
//            Main.thestage.setScene(scene3);
            //New Form
            Parent window3 = (AnchorPane) FXMLLoader.load(getClass().getResource("/application/EditMenu.fxml"));
            Scene newScene = new Scene(window3);
            Stage mainWindow = (Stage) ((Node) e.getSource()).getScene().getWindow();
            mainWindow.setScene(newScene);
    ...
    /**
     * <code>submit</code> Submit current order into the database. Record this
     * activity into database.
     *
    ...
    /**
     * <code>modify</code> Modify the latest order and write the changes into
     * the database. Record this activity into database.
     *
